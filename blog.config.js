...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个普通人, Hi，我是一个热爱芝士的人,Hi，一个追逐梦想的人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '木白', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱芝士🧀的人', // 作者简介
  ...
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'LXGW WenKai',   // font-sans font-light
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '木白的芝士小屋', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个热爱芝士的人', // 站点描述，被notion中的页面描述覆盖
