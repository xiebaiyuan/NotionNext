...
export async function generateRss(props) {
  ...
  const DESCRIPTION = siteInfo?.description + " feedId:69298335644214273+userId:69290848602792960"
  ...
  const feed = new Feed({
    ...
    copyright: `All rights reserved ${year}, ${AUTHOR}  This message is used to verify that this feed (feedId:69298335644214273) belongs to me (userId:69290848602792960). Join me in enjoying the next generation information browser https://follow.is.`,
    author: {
      name: AUTHOR,
      email: CONTACT_EMAIL,
      link: LINK
